...
Linode's article on how to use |Use Public Key Authentication with SSH|
...
#. Then, copy the public key to the server and disable logging in using root
   with a password.

   * See post |How to Set Up SSH for your Ubuntu 18.04 VPS or Dedicated Server|
     to help you.
...
.. figure:: images/ssh-key1.png

    PuTTY security alert to a changers host key

.. figure:: images/ssh-key2.png
