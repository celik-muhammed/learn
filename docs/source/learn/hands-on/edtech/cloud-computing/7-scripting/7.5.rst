...
Use |A Beginners Guide To Cron Jobs| and |Creating a custom Cron Job|
to help you.
...
two things: |br| **(1)** Did it run, and **(2)** did it run correctly.

* You can run a cron job manually using Webmin: |br|
...
* You can configure a command to send |standard output| (stdout) results
