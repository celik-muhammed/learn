...
.. note:: This lab builds on :ref:`Lab 5. Writing to a file <Writing to a file>`.


You need three flags to empty or create the file using |open (code wiki)|.

    #. ``O_WRONLY`` opens the file in write only mode.
    #. ``O_TRUNC``  empties the file of any data.
    #. ``O_CREAT``  creates the file if it does not exit. |br|
...
#. Create a function that empties an existing file or creates the file
