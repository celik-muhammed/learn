...
This lab shows methods of deleting (unlinking) a file or
erasing data in an existing file.

Lab 8 Resources
---------------

- |unlink (Microsoft)| function (Microsoft)
- |remove (Microsoft)| function (Microsoft)
- |open (Microsoft)| function (Microsoft)
- |open (code wiki)| function (Code Wiki)
...
.. admonition:: Source & license
   ...
   Source page:
   https://labs.bilimedtech.com/operating-systems/8/overview.html
