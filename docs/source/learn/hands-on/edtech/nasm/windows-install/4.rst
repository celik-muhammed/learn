...
the |ASCII codes| as a your reference.
...
#. Create a new ``.asm`` file called ``lab1-YourName.asm``
#. Change the output to display your name and the ASCII representation.
...
#. Upload the ``.asm`` and ``.obj`` files to the LMS.

.. note:: Modify the code header to include the:
