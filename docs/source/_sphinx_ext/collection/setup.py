...
collection directive asks for them first, and only writes them when a page
actually used one.
"""
...
def ensure_assets(app: Any) -> None:
    ...
    Failures are swallowed. The assets are progressive enhancement -- the
    ...
    except Exception:  # noqa: BLE001 - enhancement, never load-bearing
        pass
